-- Migration: Add Final Missing Tables (Fixed Version)
-- Date: 2025-01-XX
...
-- Note: Default notification settings can be added later when real users exist
-- INSERT INTO notification_settings (user_id, notification_type, delivery_method, frequency) VALUES
-- ('real-user-uuid', 'critical_messages', 'email', 'immediate'),
-- ('real-user-uuid', 'system_alerts', 'email', 'daily'),
-- ('real-user-uuid', 'quiz_results', 'email', 'immediate')
